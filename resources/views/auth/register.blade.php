...
<div class="row">
    <div class="col-auto">
        <img src="img/forum-wo.jpg" alt="">
    </div>
    <div class="col forum-wo-brand">
      ...
      <div class="row justify-content-center" id="register-box">
        ...
        <small class="d-block text-center mt-3 in-forum">Already have an account? <a href="/login">Log in</a></small>
    </div>
    </div>
</div>
